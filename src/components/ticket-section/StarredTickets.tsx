import starredArrows from "../../assets/headerImages/tickets-section/starredArrows.svg";
  ...
  return (
    ...
    <div className="flex flex-col -gap--rounded-md">
      <div className="flex items-center gap-[10px]">
        <h4 className="font-Lato text-[#000C40] leading-none font-bold group-hover:text-white">
          0,000
        </h4>
        <img src={starredArrows} alt="" className="md:w-5 md:h-5" />
      </div>
