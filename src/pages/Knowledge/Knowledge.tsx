    ...
    <div className="lg:grid grid-cols-4 gap-4">
      <div className="col-span-3 border-blue-600 bg-white p-5">
        ...
        <div className="flex gap-4 justify-between align-middle p-2 border rounded-lg">
          <div className="flex gap-4 border-spacing-1">
            <h1>icon</h1>
            ...
            <div className="border min-w-16 rounded-lg flex items-center  justify-center">
              <h2 className="text-center pl-3">Category Item</h2>
            </div>
          </div>
